...
# ========================= CONSTANTS ============================
AFKSTR = [
    "Sibuk cok tunggu ya fatur lagi afk botnya yang jalan.!",
    "silahkan tag saya di salah satu grub ini @Frozenteamofficial.",
    "Cie yang kangen sabar ya off biasanya on kok tunggu aja.",
    "tolong tag saya di sini @Republik_TelegramID untuk tx ya",
    "Ehh abang bentar yo lagi off.",
    "Waalaikumsalam sabar ya gue butuh asupan.",
    "D5zHoB8RwgZjEGu78MC1ni23c6w746q5By 1k doge sebelum on udah di kirim :v.",
    "Kaboorrrrrrrr tapi boong sabar yaa.",
    "Mau apa bebs😘.",
    "Lagi nyari yaa? tag di @HappyFamilyID2 aja.",
...
async def set_afk(afk_e):
    ...
    if string:
        ...
        AFKREASON = string
        await afk_e.edit(f"Fatur off!\
        \nReason: `{string}`")
    else:
        await afk_e.edit("Ape luu!")
    if BOTLOG:
